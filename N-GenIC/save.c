...
#define BUFFER 10
  ...
  header.w0 = w0;
  header.wa = wa;
  header.comoving_distance = 0.0; // This is not implemented yet, but not important for initial conditions file.
  for (i=0; i<6; i++) header.nothing[i] = 0; // filling empty spaces with zeros.
  header.nothing1 = 0;
  header.nothing2 = 0;
  // </JMK>
